...
class TourLocationPreview extends StatefulWidget {
  final Tour tour;

  const TourLocationPreview({Key? key, required this.tour}) : super(key: key);

  @override
  State<TourLocationPreview> createState() => _TourLocationPreviewState();
}

class _TourLocationPreviewState extends State<TourLocationPreview> {
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      ctgSlider(ctgList),
                      SizedBox(height: 5,),
                      Container(width: width * .9,height: height - 228, padding: EdgeInsets.only(bottom: wDefaultPadding),
                        child: TourAddLocationTab(locations: widget.tour.destinations, facts: widget.tour.facts, preview: true,),)
                    ],
                  ),
                ),
              )),
